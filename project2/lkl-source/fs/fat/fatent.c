...
int fat_ent_read(struct inode *inode, struct fat_entry *fatent, int entry)
{
	...
	printk(KERN_INFO "inside fat_ent_read\n");					// print
		  ...
		  int new, int wait)
{
	...
	printk(KERN_INFO "inside fat_ent_write\n"); 	//print
				     ...
				     struct fat_entry *fatent)
{
	...
	printk(KERN_INFO "inside fat_ent_read_block\n");	//print
...
int fat_alloc_clusters(struct inode *inode, int *cluster, int nr_cluster)
{
	...
	printk(KERN_INFO "inside fat_alloc_clusters\n");			// print
