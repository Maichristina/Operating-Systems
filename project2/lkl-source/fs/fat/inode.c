...
//FILE *fptr;			// my code file descriptor
...
int fat_add_cluster(struct inode *inode)
{
	...
	printk(KERN_INFO "inside fat_add_cluster\n");		//print
				  ...
				  struct buffer_head *bh_result, int create)
{
	...
	printk(KERN_INFO "inside __fat_get_block\n");			// print
...
{
	struct super_block *sb = inode->i_sb;
	printk(KERN_INFO "inside fat_get_block\n");				// print
...
struct inode *fat_iget(struct super_block *sb, loff_t i_pos)
{
	...
	printk(KERN_INFO "inside fat_iget\n"); 			// print
			...
			struct msdos_dir_entry *de, loff_t i_pos)
{
	...
	printk(KERN_INFO "inside fat_build_inode\n");				//print
...
static struct inode *fat_alloc_inode(struct super_block *sb)
{
	...
	printk(KERN_INFO "inside fat_alloc_inode\n");				//print
...
static int __fat_write_inode(struct inode *inode, int wait)
{
	...
	printk(KERN_INFO "inside __fat_write_inode\n");				//print
...
static int fat_write_inode(struct inode *inode, struct writeback_control *wbc)
{
	...
	printk(KERN_INFO "inside fat_write_inode\n");		//print
...
static int fat_read_root(struct inode *inode)
{
	...
	printk(KERN_INFO "inside fat_read_root\n");			// print
...
static unsigned long calc_fat_clusters(struct super_block *sb)
{
	...
	printk(KERN_INFO "inside calc_fat_clusters\n");			// print
...
static int __init init_fat_fs(void)
{
	...
	printk(KERN_INFO "inside __init_fat_fs\n");		//print
